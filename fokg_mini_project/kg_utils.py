...
class KGUtils:
    ...
    def enrich_kg_with_hierarchy(kg_file, hierarchy_file, output_file):
        """
        Enrich a knowledge graph (KG) with hierarchical information.

        Args:
            kg_file (str): Path to the knowledge graph file in NT format.
            hierarchy_file (str): Path to the hierarchy file in NT format.
            output_file (str): Path to save the enriched knowledge graph.
        """
        # Namespaces
